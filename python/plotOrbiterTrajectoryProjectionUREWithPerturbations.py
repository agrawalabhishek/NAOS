...
try:
        database = sqlite3.connect("../data/regolith_launched_from_leading_edge/multiple_launch_velocity_with_perturbations/leadingEdge.db")
...
## Set up the figure
fig = plt.figure( )
plt.suptitle( "Particle trajectory with perturbations around Eros (Body fixed frame)" )
