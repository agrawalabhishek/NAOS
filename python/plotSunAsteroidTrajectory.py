...
data = pd.read_csv( '../data/regolith_launched_from_longest_edge/multiple_launch_velocity_with_perturbations/simulation_time_9_months/3.2Density_1cmRadius/sunEphemeris_phase45.csv' )
